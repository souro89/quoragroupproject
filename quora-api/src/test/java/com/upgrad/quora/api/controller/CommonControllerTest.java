...
public class CommonControllerTest {
    ...
    public void detailsUsingNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/userprofile/database_uuid1").header("authorization", "Bearer non_existing_access_token"))
    ...
    public void detailsOfNonExistingUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/userprofile/non_existing_user").header("authorization", "Bearer database_accesstoken"))
